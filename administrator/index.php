                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin1@captains.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointments.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Appointments</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
